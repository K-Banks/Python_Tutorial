...
def construct_feature_columns():
    ...
    housing_median_age = tf.feature_column.numeric_column("houseing_median_age")
    ...
    # Make feature cross with latitude and longitude
...
# Create quartile based bucketized features
